...
pub use frame_support::{
	...
	traits::{
		ConstU128, ConstU32, ConstU64, ConstU8, KeyOwnerProofSystem, Randomness, StorageInfo, Nothing, ConstBool, AsEnsureOriginWithArg,
	},
	weights::{
		constants::{
...
pub use frame_system::{ EnsureSigned, Call as SystemCall };
...
impl pallet_contracts::Config for Runtime {
	...
	type ChainExtension = pallet_assets_chain_extension::substrate::AssetsExtension; // configure the assets extension for contracts
